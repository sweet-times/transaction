...
// Create Temporary Input Area
function copyText(htmlElement) {
    let elementText = htmlElement.innerText;

    let inputElement = document.createElement('input');
    inputElement.setAttribute('value', elementText);
    inputElement.setAttribute('id', 'copytxt')
    document.body.appendChild(inputElement);
    inputElement.select();
    navigator.clipboard.writeText(document.getElementById('copytxt').value);
...
function() {
    ...
    // Display Total Price
    const priceRupiah = rupiah(total);
    document.getElementById('totalPrice').innerHTML = priceRupiah;

    console.log(priceObject);
    console.log(priceRupiah);

    // Copy Message to Clipboard
    document.getElementById('message').innerHTML = `Your total price is ${priceRupiah}.`;
